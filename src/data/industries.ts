...
export const INDUSTRIES: Industry[] = [
  {
    ...
    metaDescription:
      "Promovează ansambluri rezidențiale, agenții și proiecte imobiliare în presa din toată România. Publicare în 24 de ore lucrătoare, raport cu linkuri. De la 150 RON.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Adu pacienți noi cu articole în presa locală: medici noi, aparatură modernă, servicii unice în județ. Publicare în 24 de ore lucrătoare, conform reglementărilor.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Poziționează-te ca autoritate juridică: comentarii pe legislație nouă, ghiduri pentru public, prezentarea echipei. Publicare în 50 de ziare în 24 de ore lucrătoare.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Lansezi un produs, ai închis o rundă de finanțare, angajezi masiv? Publicăm știrea în 50 de ziare în 24 de ore lucrătoare — vizibilitate pentru clienți și investitori.",
    intro: [
  ...
  },
  {
    ...
    metaTitle: "PR HoReCa — restaurantul tău în presa locală în 24 de ore lucrătoare",
    metaDescription:
      "Deschidere de local, meniu nou, chef premiat? Publică în ziarele orașului tău și umple mesele. Articole cu poze, de la 150 RON, publicate în 24 de ore lucrătoare.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Câștigă licitații și clienți mari: firmele de construcții vizibile în presă inspiră încredere. Publicare proiecte, echipamente, angajări — în 24 de ore lucrătoare.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Lansări de modele, oferte de sezon, service-uri autorizate — publicate în ziarele din județul tău în 24 de ore lucrătoare. Adu clienți în showroom cu presa locală.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Umple locurile la înscrieri: părinții aleg școlile despre care citesc. Articole despre rezultate, profesori, programe — publicate în 24 de ore lucrătoare în presa locală.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Clientele noi vin din încredere: publică în presa orașului deschiderea, aparatura nouă, specialiștii tăi. Articole cu poze, publicate în 24 de ore lucrătoare.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Turiștii vin din alte județe — presa națională îi aduce. Publică oferte de sezon, evenimente și povestea locului în 50 de ziare, în 24 de ore lucrătoare.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Strângeri de fonduri, campanii de 3,5%, proiecte comunitare — vizibilitatea în presă aduce donatori și voluntari. Publicare în 24 de ore lucrătoare, în 50 de ziare.",
    intro: [
