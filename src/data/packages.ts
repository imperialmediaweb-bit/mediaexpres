...
const COMMON_HIGHLIGHTS = [
  ...
  "Link-uri livrate în 24 de ore lucrătoare",
...
export const STANDARD_PACKAGES: Package[] = [
  {
    ...
    highlights: [
      ...
      "Link livrat în 24 de ore lucrătoare",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Linkuri livrate în 24 de ore lucrătoare",
      "Raport PDF cu toate URL-urile",
      "Permanent online",
    ],
  },
...
export const CASINO_PACKAGES: Package[] = [
  {
    ...
    highlights: [
      ...
      "Link livrat în 24 de ore lucrătoare + raport",
      "Permanent online",
    ],
  },
  {
    ...
    highlights: [
      ...
      "Distribuție Facebook",
      "Linkuri livrate în 24 de ore lucrătoare + raport",
      "Permanent online",
    ],
  },
  {
