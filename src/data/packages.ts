...
const COMMON_HIGHLIGHTS = [
  ...
  "Link-uri livrate în 12 ore lucrătoare",
...
export const STANDARD_PACKAGES: Package[] = [
  {
    ...
    highlights: [
      ...
      "Link livrat în 12 ore lucrătoare",
...
export const CASINO_PACKAGES: Package[] = [
  {
    ...
    highlights: [
      ...
      "Link livrat în 12 ore lucrătoare + raport",
      "Permanent online",
    ],
  },
  {
    ...
    highlights: [
      ...
      "Distribuție Facebook",
      "Linkuri livrate în 12 ore lucrătoare + raport",
      "Permanent online",
    ],
  },
  {
