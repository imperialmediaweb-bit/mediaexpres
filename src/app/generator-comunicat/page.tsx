...
const FAQ = [
  ...
  },
  {
    ...
    a: "Cea mai simplă variantă: pachetul Național MediaExpres îl publică pe 41 ziare locale + 9 naționale + 46 de pagini de Facebook în 12 ore lucrătoare. Costă 1500 RON, plătit o singură dată, rămâne online permanent.",
  },
  {
      ...
      <section className="bg-brand-navy text-white">
        <div className="container py-16 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-white/80">
            ...
            naționale + 46 de pagini de Facebook. Linkurile rămân online permanent,
            primești raport PDF complet cu toate URL-urile.
          </p>
          <ul className="mt-8 grid gap-3 sm:grid-cols-3 max-w-3xl mx-auto text-sm">
            {[
              "Articol pe 50 de ziare reale, care rămâne permanent",
