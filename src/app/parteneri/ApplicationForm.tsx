    ...
    return (
      <div className="rounded-xl border-2 border-green-200 bg-green-50 p-8 text-center">
        ...
        <p className="mt-3 text-slate-700">
          Va contactam pe email in maxim 12 ore lucratoare cu fie aprobarea +
          credentialele de cont reseller, fie cu intrebari clarificatoare.
        </p>
        <p className="mt-4 text-xs text-slate-500">
          Daca nu ne vedeti email-ul in 12 ore lucrătoare, verificati folder-ul Spam sau
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-slate-500 text-center">
        Va raspundem in 12 ore lucratoare pe email-ul de mai sus.
      </p>
    </div>
  );
}
