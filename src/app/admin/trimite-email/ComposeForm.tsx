...
const SABLOANE: { eticheta: string; subiect: string; text: string }[] = [
  ...
  },
  {
    ...
    text: [
      ...
      "",
      "Vă mai întreb două lucruri:",
      "",
      "• Cum preferați publicarea: variantă unică pe fiecare ziar (recomandat, se indexează mult mai bine) sau textul dumneavoastră identic pe toate cele 50, dacă e aprobat oficial și nu are voie schimbat.",
      "",
      "• Pe ce ziar doriți promovarea pe Facebook. În preț sunt incluse 3 zile de promovare plătită a postării cu articolul dumneavoastră, pe pagina unui ziar din rețea — alegeți dumneavoastră care, de obicei cel din județul în care lucrați. Dacă nu aveți o preferință, alegem noi ziarul potrivit.",
      "",
      "Ce nu publicăm, ca să știți din start: conținut medical (tratamente, vindecări, suplimente prezentate ca alternativă la tratament), pariuri și cazinouri fără licență ONJN, sau texte care încalcă legea. În rest, publicăm orice material despre firma dumneavoastră.",
      "",
