    ...
    <div>
      ...
      <div className="mt-10 rounded-xl border border-amber-200 bg-amber-50 p-5">
        <p className="text-sm text-amber-900">
          <strong>Securitate:</strong> Această pagină este blocată în{" "}
          <code>robots.txt</code> și are meta <code>noindex, nofollow</code>. NU
          distribui screenshot-uri ale acestei pagini, nu adăuga URL-uri către ea
          în conținut public. Rețeaua noastră e protejată prin anonimitate.
      </p>
      </div>
    </div>
  );
...
function StatPill({
  ...
  return (
    ...
    >
      ...
      <div className="mt-1 font-serif text-3xl font-bold text-brand-navy">
        {value}
      </div>
    </div>
  );
