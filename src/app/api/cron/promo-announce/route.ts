    ...
    for (const r of recipients) {
      ...
      const res = await sendEmail({
        ...
        html: wrapEmail(
          ...
          <p>Pe scurt, ce primești: articol unic pe fiecare ziar (zero conținut duplicat), 50 de backlinks dofollow, publicare în maximum 4 ore lucrătoare, raport complet cu linkurile și factură fiscală.</p>
