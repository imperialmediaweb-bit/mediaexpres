    ...
    for (const r of recipients) {
      ...
      const res = await sendEmail({
        ...
        html: wrapEmail(
          ...
          <p>Pe scurt, ce primești: articol unic pe fiecare ziar (zero conținut duplicat), 50 de linkuri permanente către site-ul tău, publicare în maximum 12 ore lucrătoare, lista completă cu linkurile și factură fiscală.</p>
