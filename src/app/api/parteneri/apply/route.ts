...
export async function POST(req: Request) {
  try {
    ...
    const adminBody = `
      ...
      <p style="margin-top:20px;">Raspundeti aplicantului in 24 de ore lucrătoare cu fie aprobare + credentiale cont, fie intrebari clarificatoare.</p>
    `;
    ...
    const userBody = `
      ...
      <p>Iti raspundem in maxim 24 de ore lucratoare pe acest email cu:</p>
      <ul>
