...
export async function POST(req: Request) {
  try {
    ...
    const adminBody = `
      ...
      <p style="margin-top:20px;">Raspundeti aplicantului in 12 ore lucrătoare cu fie aprobare + credentiale cont, fie intrebari clarificatoare.</p>
    `;
    ...
    const userBody = `
      ...
      <p>Iti raspundem in maxim 12 ore lucratoare pe acest email cu:</p>
      <ul>
