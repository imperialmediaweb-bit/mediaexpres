      ...
      <div className="bg-brand-navy text-white py-12">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mt-3 text-white/80 max-w-2xl mx-auto">
            ...
            cu raport PDF livrat în 24 de ore lucrătoare. Tu trimiți tematica, noi scriem şi publicăm.
          </p>
          {agency && (
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 space-y-16">
        ...
        <div className="grid sm:grid-cols-3 gap-6 text-center">
          <div className="rounded-xl bg-white border border-slate-200 p-6">
            ...
            <p className="font-semibold text-brand-navy">Publicare în 24 de ore lucrătoare</p>
        ...
        <div className="rounded-2xl bg-brand-navy text-white p-8 text-center">
          ...
          <p className="text-white/75 text-sm mb-6 max-w-lg mx-auto">
            ...
            noi scriem comunicatul cu AI şi publicăm pe 50 de ziare în 24 de ore lucrătoare.
