...
export function StrategyGenerator({
  ...
  async function generate() {
    ...
    try {
      ...
      setError(
        `Imi pare rau, am o problema tehnica acum (${msg}). Scrieti-ne la contact@mediaexpress.ro si va trimitem strategia in 4h.`
      );
    } finally {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-amber-50/30 to-rose-50/30 py-16 md:py-20">
      <div className="pointer-events-none absolute -top-24 -right-4h-96 w-96 rounded-full bg-amber-200/40 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 -left-4h-96 w-96 rounded-full bg-rose-200/40 blur-3xl" />
