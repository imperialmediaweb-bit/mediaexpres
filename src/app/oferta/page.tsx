...
const BENEFITS = [
  {
    ...
    description:
      "Advertorial sau comunicat distribuit în rețeaua noastră de 50 de ziare proprii — site-uri active, cu trafic real, în care se publică circa 500 de articole pe zi.",
  },
  {
    icon: Globe,
