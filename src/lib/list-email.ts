...
// promisiunea de pe /oferta-500 (12 ore lucratoare). Nu inventam un "ideal" pe
...
export const ARTICLE_SPECS_HTML = `
    ...
    <table style="width:100%;border-collapse:collapse;font-size:14px;line-height:1.5;">
      ...
      <tr>
        ...
        <td style="padding:6px 0;color:#111111;"><strong>Maximum 12 ore lucrătoare</strong> de la confirmarea comenzii până când toate linkurile sunt live. Primești raportul cu toate adresele pe email, în PDF și Excel.</td>
      </tr>
      <tr>
...
export function buildListEmail(firstName: string): string {
  ...
  return wrapEmail(
    ...
    ${newspaperListHtml()}
    <p style="margin-top:24px;">Un articol publicat pe toată rețeaua, cu raport complet cu linkuri, costă <strong>500 lei</strong> (ofertă de intrare${deadline ? `, <strong>valabilă până pe ${deadline}</strong>` : ""}) — publicare în maximum 12 ore lucrătoare. Articolul rămâne permanent online.</p>
    ...
    <p>Cum funcționează: plătești online cu cardul (primești <strong>factură fiscală</strong> pe email în aceeași zi lucrătoare), apoi ne dai articolul tău sau îl scriem noi din datele firmei tale — plus până la 3 poze.</p>
    ${ARTICLE_SPECS_HTML}
