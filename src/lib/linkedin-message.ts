...
4. PREZINTI RETEAUA CU FAPTE CONCRETE (acestea TREBUIE sa apara TOATE, le poti formula in 1-2 propozitii):
   ...
   - "circa 500 de articole publicate zilnic în rețea"
   - "distribuție și pe 46 de pagini de Facebook"
   Poti compacta: "50 ziare proprii (41 locale, 9 naționale, 1 diaspora) + 46 de pagini de Facebook, circa 500 de articole/zi"
...
Bună ziua, Alexandra! Sunt ${SENDER_FIRST}, administrator MediaExpres — aș vrea să vă prezint o oportunitate: rețea de 50 de ziare online proprii (41 locale + 9 naționale + 1 diaspora), cu circa 500 de articole publicate zilnic și distribuție pe 46 de pagini de Facebook. Vă trimit oferta pe email — îmi confirmați adresa?

Pentru Mădălina Săvulescu, Communication Manager la Nespresso:
Bună ziua, Mădălina! Sunt ${SENDER_FIRST} de la MediaExpres. Vă contactez cu o ofertă relevantă pentru rolul dvs.: rețeaua noastră de 50 de ziare proprii (41 locale, 9 naționale, 1 diaspora), cu circa 500 de articole publicate zilnic și distribuție pe 46 de pagini de Facebook. Detaliile vi le trimit pe email — îmi spuneți adresa?

Pentru Cristian, PR Specialist la o agenție:
Bună ziua, Cristian! Am o propunere care s-ar potrivi cu activitatea dvs. de PR — MediaExpres: 50 de ziare online proprii (41 locale + 9 naționale + 1 diaspora), circa 500 de articole publicate zilnic și distribuție pe 46 de pagini de Facebook. Sunt ${SENDER_FIRST}. Vă pot trimite oferta pe email — confirmați adresa?

Pentru Andrei, Founder:
Bună ziua, Andrei! Sunt ${SENDER_FIRST} de la MediaExpres. Vă scriu fiindcă văd o oportunitate concretă: rețea de 50 de ziare online proprii (41 locale, 9 naționale, 1 diaspora), cu circa 500 de articole publicate zilnic și distribuție pe 46 de pagini de Facebook. Vă trimit pachetele și tarifele pe email — îmi dați adresa?

Raspunde DOAR cu textul mesajului. Niciun caracter in plus. FAPTELE DESPRE RETEA (41 locale, 9 naționale, 1 diaspora, ziare PROPRII, circa 500 de articole/zi, 46 de pagini de Facebook) trebuie MEREU sa apara — ele dau credibilitate.`;
