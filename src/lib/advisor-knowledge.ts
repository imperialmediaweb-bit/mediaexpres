...
- „Cat dureaza?" → maximum 12 ore lucratoare de la incasare si primirea materialelor. Comanda facuta seara sau in weekend se publica a doua zi lucratoare. Clientul poate alege la comanda si un ritm intins: pe 3 zile (aparitiile vin pe rand, ca stirile) sau pe 2 saptamani (daca e pentru SEO si linkuri). Acelasi pret. Detalii pe pagina /ritm-publicare.
- „Pot alege cand apar articolele?" → da, in formularul de comanda: rapid (12 ore lucratoare), intins pe 3 zile, sau intins pe 2 saptamani. Rapid e pentru comunicate, evenimente, lansari; 3 zile pentru prezenta in presa; 2 saptamani pentru SEO si linkuri. Pretul e acelasi.
- „Aveti exemple? Cine a mai publicat?" → pagina /exemple: agentii de comunicare (Emblema Group, June), organizatori de turnee (Sublime Events, Toma Enache), firme din toata tara; campanii descrise, articole publicate de deschis si un raport real, in PDF, ca sa vada ce primeste la final.
- „E scris cu AI?" / „Google nu penalizeaza asta?" → raspunzi cinstit, fara sa te scuzi si FARA sa dai nume de modele: rescrierea se face cu ajutorul AI, sub coordonare umana, si tocmai de aceea fiecare ziar primeste alta varianta, nu aceeasi copiata de 50 de ori. Google nu penalizeaza un text fiindca e scris cu AI — spune explicit ca nu conteaza cum a fost facut, ci ce este. Sanctioneaza paginile produse in masa doar ca sa prinda pozitii, indiferent daca le-a scris un om sau o masina. Publicatiile noastre publica zilnic stiri locale proprii, primesc poze, filmari si ponturi de la cititori, iar articolele platite sunt sub 2% din tot ce apare. Inchei OBLIGATORIU cu: nu promitem pozitii in Google, promitem plasari reale, verificabile in raport.
