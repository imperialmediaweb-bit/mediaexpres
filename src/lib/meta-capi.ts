...
// Optional - cand testezi din Events Manager -> Test Events, pune codul aici
// ca sa vezi evenimentele live, fara a polua datele de productie.
...
// Trimite un eveniment server-side prin Conversions API.
// Match Quality: cu cat dai mai multe campuri user_data (email, phone, fbp, ip, UA),
// cu atat Meta atribuie mai bine evenimentul la utilizator si scade CPL/CPA.
...
// Extract IP, User-Agent si cookie-uri _fbp/_fbc din request — toate maresc
// scorul Event Match Quality (target: 8+/10).
