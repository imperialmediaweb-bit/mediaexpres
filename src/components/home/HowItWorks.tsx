...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "În maximum 12 ore lucrătoare publicăm pe rețeaua noastră + distribuim automat pe 46 de pagini de Facebook.",
  },
  {
    icon: FileCheck2,
      ...
      <div className="container">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="lead mt-4">
            Proces simplu, rezultate mari. În mai puțin de 12 ore lucrătoare ești pe prima pagină a celor 50 de
            ziare din rețea.
          </p>
        </div>
