...
|---|---|---|
| `unit.ts` | 118 | logica pura: termenul rulant al ofertei, preturi si pachete, emailul cu lista, cunostintele consultantului, generatoarele de .xlsx si .pdf (validate byte cu byte), integritatea datelor retelei |
...
| `flows.mjs` | 51 | fluxurile reale in Chromium: comanda, pretul de cazino, pixelul, fluxul OP, mobil 390px, SEO |
